...
public class ODTTemplateNotFoundException extends RuntimeException implements IdentifiableException {

    private static final long serialVersionUID = -1507015759045347536L;
    ...
    public String getCode() {
        return JacksonConversionStatus.ODT_TEMPLATE.getDesription();
    }

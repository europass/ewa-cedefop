 ...
 */
public class ViewVisitsExample {

    /**
     * LOGGER
     */
    private static final Logger LOG = LoggerFactory.getLogger(ViewVisitsExample.class);
     ...
     */
    private static final String APPLICATION_NAME = "europass.cedefop.europa.eu";

    private static final String privateKeyFileName = "/Europass-Statistics.p12";

    private static final String serviceAccountID = "1047644667530@developer.gserviceaccount.com";
    ...
    private static Credential authorize() throws GeneralSecurityException, IOException {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(
                JSON_FACTORY, new InputStreamReader(
                        ViewVisitsExample.class.getResourceAsStream("/client_secrets.json")));
    ...
    private static PrivateKey getPrivateKey(String keyFile, String alias, String password) throws KeyStoreException, IOException, NoSuchAlgorithmException, CertificateException, UnrecoverableKeyException {
        ...
        keystore.load(ViewVisitsExample.class.getResourceAsStream(keyFile), password.toCharArray());
    ...
    private static GaData executeDataQuery(Analytics analytics, String profileId) throws IOException {
        ...
        return analytics.data().ga().get("ga:" + profileId, // Table Id. ga: + profile id.
                "2012-05-01", // Start exact_date.
                "2012-05-31", // End exact_date.
                "ga:pageviews") // Metrics.
                .setDimensions("ga:country,ga:browser")
                .setSort("ga:country,ga:browser")
                //			.setFilters("ga:medium==organic")
                //			.setMaxResults(25)
                //			.setFilters("ga:country==Spain,ga:country==Greece")
                .execute();
    }

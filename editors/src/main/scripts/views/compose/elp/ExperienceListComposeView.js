define(
        [
            ...
            'hbs!templates/compose/elp/experienceList',
            'views/interaction/ListView'
        ],
        function ($, _, ComposeView, HtmlTemplate, ListView) {

            var ExperienceListComposeView = ComposeView.extend({
            ...
            return ExperienceListComposeView;
        }
);
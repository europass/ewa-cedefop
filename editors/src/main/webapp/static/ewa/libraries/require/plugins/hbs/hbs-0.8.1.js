...
//>>excludeStart('excludeHbs', pragmas.excludeHbs)
  'handlebars', 'underscore', 'i18nprecompile', 'jsonjs'
...
//        [ekar 04/07/2014: Add a check for whether fs is defined, otherwise build with removeCombined fails]
          if ( config.removeCombined && path && fs !== undefined ) {
            fs.unlinkSync(path);
          }

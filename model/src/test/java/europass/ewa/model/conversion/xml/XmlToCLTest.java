...
public class XmlToCLTest extends XmlMapperTest {

    @Test
    public void addressee() throws JsonMappingException, IOException {

        String xml = CLMockObject.PREFIX_XML + CLMockObject.PREFIX_COVERLETTER_XML
                + CLMockObject.ADDRESSEE_XML
                + CLMockObject.SUFFIX_COVERLETTER_XML + CLMockObject.SUFFIX_XML;
    ...
    public void addresseeWithAddressLine2() throws JsonMappingException, IOException {
        ...
        String xml = CLMockObject.PREFIX_XML + CLMockObject.PREFIX_COVERLETTER_XML
                + CLMockObject.ADDRESSEE_WITH_ADDRESSLINE2_XML
                + CLMockObject.SUFFIX_COVERLETTER_XML + CLMockObject.SUFFIX_XML;
    ...
    public void documentation() throws JsonMappingException, IOException {
        ...
        String xml = CLMockObject.PREFIX_XML + CLMockObject.PREFIX_COVERLETTER_XML
                + CLMockObject.DOCUMENTATION_XML
                + CLMockObject.SUFFIX_COVERLETTER_XML + CLMockObject.SUFFIX_XML;

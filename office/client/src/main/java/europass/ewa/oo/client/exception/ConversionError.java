...
public class ConversionError extends RuntimeException implements IdentifiableException {

    private static final long serialVersionUID = 3460205054766088536L;
    ...
    public String getCode() {
        return OfficeStatus.OFFICE_CONVERSION.getDesription();
    }
}

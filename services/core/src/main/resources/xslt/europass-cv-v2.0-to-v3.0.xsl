...
<xsl:stylesheet 
    ...
    <xsl:template match="/learnerinfo">
        ...
        <xsl:element name="SkillsPassport">
            ...
            <xsl:attribute name="xsi:schemaLocation">http://europass.cedefop.europa.eu/Europass http://europass.cedefop.europa.eu/xml/EuropassSchema_V3.0.3.xsd</xsl:attribute>
    ...
    <xsl:template name="NativeLinguisticSkill">
        <xsl:if test="@type = 'europass:mother' and *" xml:base="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <xsl:template name="ForeignLinguisticSkill">
        <xsl:if test="@type = 'europass:foreign' and *" xml:base="http://www.w3.org/2001/XMLSchema-instance">
           ...
           <xsl:element name="Skills">
               <xsl:if test="languagelist != 'null'">
                  <xsl:element name="Linguistic">
                       ...
                       <xsl:if test="count(languagelist/language[@type = 'europass:mother']) > 0" xml:base="http://www.w3.org/2001/XMLSchema-instance">
                      ...
                      <xsl:if test="count(languagelist/language[@type = 'europass:foreign']) > 0" xml:base="http://www.w3.org/2001/XMLSchema-instance">
               ...
               <xsl:if test="skilllist != 'null'">
                  ...
                  <xsl:for-each select="skilllist/structured-skill">
                      <xsl:if test="@type='europass:driving' and *" xml:base="http://www.w3.org/2001/XMLSchema-instance">

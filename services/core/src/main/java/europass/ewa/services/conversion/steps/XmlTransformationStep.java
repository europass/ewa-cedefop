...
public class XmlTransformationStep extends AbstractDocumentGenerationStep {

    private static final Logger LOG = LoggerFactory.getLogger(XmlTransformationStep.class);

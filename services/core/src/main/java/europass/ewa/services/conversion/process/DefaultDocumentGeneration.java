...
public class DefaultDocumentGeneration implements DocumentGeneration {

    private final DocumentUpdateDateStep step1;

    private final DefaultPreferencesStep step2;

    private final BinaryDataPopulationStep step3;
    ...
    @Inject
    public DefaultDocumentGeneration(DocumentUpdateDateStep step1, DefaultPreferencesStep step2, BinaryDataPopulationStep step3, AttachmentsVisibilityStep step4,

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
							  ...
							  xmlns:europass_prev="http://europass.cedefop.europa.eu/Europass/V1.0">
	...
	<xsl:template match="/europass_prev:learnerinfo">
		<xsl:element name="europass:learnerinfo">
			...
			<xsl:element name="prefs">
				...
				<xsl:element name="field">
					<xsl:attribute name="name">step1.photo</xsl:attribute>
					<xsl:attribute name="keep">false</xsl:attribute>
				</xsl:element>
			</xsl:element>
	...
	<xsl:template name="docinfo">
		...
		<xsl:element name="comment">Automatically generated Europass CV  converted from 1.0 to 2.0</xsl:element>
	</xsl:template>

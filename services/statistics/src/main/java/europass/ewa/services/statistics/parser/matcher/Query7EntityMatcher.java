...
public class Query7EntityMatcher extends QueryEntityMatcher{

	public Query7EntityMatcher(QueryEntityMatcher next){
		super(next);
	}
	...
	protected void configure(){
		...
		super.setMatch(new QueryEntityMatch(EntityTablesProperties.CUBE_ENTRY_NAT_RANK, parametersList));
	}
	
	@Override
	protected void populateQueryEntity(QueryEntityMatch matcher, QueryProperties queryProperties){
		matcher.setEntityProperties(EntityTablesProperties.CUBE_ENTRY_NAT_RANK);
	}
}

...
@Entity
@Table(name = ServicesStatisticsConstants.CUBE_ENTRY_NAT_FLANG)
public class CubeEntryNatFLang implements EntryCube, Serializable {
...
//	@Id
	...
	public void setRec_count(int id) {
		this.rec_count = id;
	}
	...
	public int getEduc_years() {
		return educ_years;
	}

	public void setEduc_years(int educ_years) {
		this.educ_years = educ_years;
	}
	...
	public void setF_lang(String flang) {
		this.flang = flang;
	}

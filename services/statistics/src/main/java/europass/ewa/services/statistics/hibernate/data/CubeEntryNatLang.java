...
@Entity
@Table(name=ServicesStatisticsConstants.CUBE_ENTRY_NAT_LANGS)
public class CubeEntryNatLang implements EntryCube, Serializable{
...
//	@GeneratedValue(strategy = GenerationType.IDENTITY)
	...
	@Id
	@Column(name="m_lang")
	public String getM_lang() { return mlang; }
	public void setM_lang(String mlang) { this.mlang = mlang; }

	@Id
	@Column(name="f_lang")
	public String getF_lang() { return flang; }
	public void setF_lang(String flang) { this.flang = flang; }

...
public class Query6EntityMatcher extends QueryEntityMatcher{

	public Query6EntityMatcher(QueryEntityMatcher next){
		super(next);
	}
...
//		super.setMatch(new QueryEntityMatch(EntityTablesProperties.CUBE_ENTRY_SHORT, parametersList));
		super.setMatch(new QueryEntityMatch(EntityTablesProperties.CUBE_ENTRY_DOCS_LANGS, parametersList));
	}
	
	@Override
	protected void populateQueryEntity(QueryEntityMatch matcher, QueryProperties queryProperties){
//		matcher.setEntityProperties(EntityTablesProperties.CUBE_ENTRY_SHORT);
		matcher.setEntityProperties(EntityTablesProperties.CUBE_ENTRY_DOCS_LANGS);
	}
}

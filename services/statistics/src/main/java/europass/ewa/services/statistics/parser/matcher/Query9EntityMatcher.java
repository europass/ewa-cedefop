...
public class Query9EntityMatcher extends QueryEntityMatcher{

	public Query9EntityMatcher(QueryEntityMatcher next){
		super(next);
	}
	...
	protected void configure(){
		...
		super.setMatch(new QueryEntityMatch(EntityTablesProperties.CUBE_ENTRY_FLANG, parametersList));
	}

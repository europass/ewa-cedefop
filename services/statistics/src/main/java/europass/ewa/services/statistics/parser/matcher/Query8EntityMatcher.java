...
public class Query8EntityMatcher extends QueryEntityMatcher{

	public Query8EntityMatcher(QueryEntityMatcher next){
		super(next);
	}
	...
	protected void configure(){
		...
		super.setMatch(new QueryEntityMatch(EntityTablesProperties.CUBE_ENTRY_MLANG, parametersList));
	}

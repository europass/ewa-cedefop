...
@Entity
@Table(name = ServicesStatisticsConstants.CUBE_ENTRY_NAT_MLANG)
public class CubeEntryNatMLang implements EntryCube, Serializable {
...
//	@Id
	...
	public void setM_lang(String mlang) {
		this.mlang = mlang;
	}

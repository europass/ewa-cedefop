 ...
 * @author at
 */
public class Query20EntityMatcher extends QueryEntityMatcher {

	public Query20EntityMatcher(QueryEntityMatcher next) {
		super(next);
	}
	...
	protected void configure() {
		...
		super.setMatch(new QueryEntityMatch(EntityTablesProperties.CUBE_ENTRY_GENDER, parametersList));
	}

	@Override
	protected void populateQueryEntity(QueryEntityMatch matcher, QueryProperties queryProperties) {
		matcher.setEntityProperties(EntityTablesProperties.CUBE_ENTRY_GENDER);
	}
}

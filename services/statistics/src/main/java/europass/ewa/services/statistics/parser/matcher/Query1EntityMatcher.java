...
public class Query1EntityMatcher extends QueryEntityMatcher{

	public Query1EntityMatcher(QueryEntityMatcher next){
		super(next);
	}
	...
	protected void configure(){
		...
		super.setMatch(new QueryEntityMatch(EntityTablesProperties.CUBE_ENTRY_DOCS, parametersList));
	}
	
	@Override
	protected void populateQueryEntity(QueryEntityMatch matcher, QueryProperties queryProperties){
		matcher.setEntityProperties(EntityTablesProperties.CUBE_ENTRY_DOCS);
	}
}

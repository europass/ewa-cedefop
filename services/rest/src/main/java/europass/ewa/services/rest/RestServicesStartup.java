...
import europass.ewa.services.rest.modules.RestServicesModule;
import europass.ewa.servlet.ServletUtils;
import europass.ewa.statistics.guice.StatisticsModule;

public class RestServicesStartup extends GuiceServletContextListener implements ServletContextListener {

    private static final Logger LOG = LoggerFactory.getLogger(RestServicesStartup.class);
    ...
    protected ModuleList getModules() {
        ...
        GeneralConfigurationModule configModule = new GeneralConfigurationModule(this.servletContext, "database-rest");
        ...
        return modules.add(
                ...
                new ExternalConfigurationModule(this.servletContext, "europass-ewa-services-rest"),
                new LogbackConfigurationModule("europass-ewa-services-rest"),
